...
\caption{Twisting in the halo-disc alignment (measured as the standard deviation of the alignment angles)
  ...
  correlation coefficient (mean value and error bars estimated via
...
With the exception of Au-27 the shape ratios $b/a$ and $c/a$ start
to differentiate from each other at radii smaller than $15$ kpc.
Above these radii, the differences between the triaxility values at
...
Au-30 & 0.62 & 0.44 & 0.77 & 0.54 & 0.87 & 0.58 & 0.85 & 0.58 & 0.75 & 0.53\\
  \hline\hline
  \end{tabular}
  \caption{Dark matter halo axial ratios of Auriga galaxies at $z=0$ at

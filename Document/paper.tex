...
available at the higher Level3 resolution and the corresponding
halos at our baseline Level4 resolution. 
The dotted lines compare the DMO simulations showing that down to
scales of $1$ kpc the two simulations give comparable results.
In MHD simulations the situation is different, as expected. 
With the exception of Au-27 the shape ratios $b/a$ and $c/a$ start
to distantiate from each other for radii smaller than $15$ kpc.
...
against stellar disc shape measurements, we report all our shape

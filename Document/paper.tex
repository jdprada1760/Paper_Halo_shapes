...
{Dark matter halo shape at $z=0$ in the Auriga simulations: radial
  evolution and alignments with the stellar disk}
...
shape as a function of radial distance.
We present this effect as a changing degree of halo shape alignment
with the stellar disk shape as a function of radius; the stronger
alignment is found at $0.25R_{200}\sim56$ kpc. 
This twisting in halo shape is almost absent from dark matter only
simulations. 
We show that a coherent halo shape with radius correlates with low
triaxility values.  
At distances close to the disk, rounder and coherent dark matter
distributions correlate with massive stellar disks and low gas density. 
In a comparison against observational constraints of dark matter halo
triaxiality for the Milky Way we find that $20\%$ of the galaxies in
our sample are consitent with observational results that favor
$b/a\approx 1$ and $c/a>0.77$ but are at odds with other results that
favor $c/a\approx0.44$. 
\end{abstract}
...
\begin{figure*}
\begin{center}
\includegraphics[width=1.0\textwidth]{correlations_angles_triaxiality_MHD.pdf}
\end{center}

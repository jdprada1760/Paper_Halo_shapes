...
\begin{figure*}
\begin{center}
  \subfloat[DM shape at small radius]{\includegraphics[width=0.4\textwidth]{Z_Triax_level3_set_A_DM.pdf}} 
  \subfloat[DM shape at large radius]{\includegraphics[width=0.4\textwidth]{Z_Triax_level3_set_A_MHD.pdf}} 
\end{center}
\caption{}
\label{fig:triaxial_history}
\end{figure*}


\begin{figure*}
\begin{center}
  \subfloat[DM shape at small radius]{\includegraphics[width=0.4\textwidth]{Z_Triax_level3_set_B_DM.pdf}} 
  \subfloat[DM shape at large radius]{\includegraphics[width=0.4\textwidth]{Z_Triax_level3_set_B_MHD.pdf}} 
\end{center}
\caption{}
\label{fig:triaxial_history}
\end{figure*}

...
In this work we analyse all the 30 halos in the \texttt{Level4}
resolution. 
All the results that we report at $z=0$ as a function of radius and
the correlations with disk properties are performed with that sample.

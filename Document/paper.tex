...
\caption{Axial ratios for all simulated halos.
  ...
  \ref{fig:triaxial_cumulative} through cumulative triaxility
  distributions}
...
\caption{Triaxility cumulative distribution at five different radii.
  ...
  in triaxility in simulations with different physics, $\Delta
...
Above $15$ kpc, the differences between the triaxility values at
...
the results for the triaxility, the halo-disc alignment and the
correlations with baryonic disc properties.}


\subsection{Triaxility}
...
To what extent the twisting and high triaxility present in the MHD
